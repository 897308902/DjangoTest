...
class Blogs(models.Model):
    ...
    marks = models.ForeignKey(Bmarks, null=True,on_delete=models.SET_NULL,related_name='blog_marks', to_field='tags',default="未分类")
    uname = models.ForeignKey(User,null=True,on_delete=models.SET_NULL, related_name='login_user', to_field='name',default='匿名')
